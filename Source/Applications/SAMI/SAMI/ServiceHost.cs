...
namespace SAMI
{
    public class ServiceHost : ServiceHostBase
    {
        ...
        protected override void ServiceStartingHandler(object sender, EventArgs<string[]> e)
        {
            ...
            // Make sure SAMI specific default service settings exist
            CategorizedSettingsElementCollection systemSettings = ConfigurationFile.Current.Settings["systemSettings"];

            systemSettings.Add("CompanyName", "Grid Protection Alliance", "The name of the company who owns this instance of the SAMI.");
            systemSettings.Add("CompanyAcronym", "GPA", "The acronym representing the company who owns this instance of the SAMI.");
        }
        ...
        private void SetupRequiredAdapters()
        {
            try
            {
                ...
                using (AdoDataConnection connection = new AdoDataConnection("systemSettings"))
                {
                    ...
                    actionAdapter.AssemblyName = $"{nameof(SAMI)}.exe";
                    actionAdapter.TypeName = $"{nameof(SAMI)}.{nameof(SnmpHost)}";
