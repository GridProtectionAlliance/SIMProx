--  ----------------------------------------------------------------------------------------------------
--  SAMI Data Structures for SQL Server - Gbtc
--
...
--       Script is based on SAMI.sql script created by James Ritchie Carroll.
...
GO
ALTER DATABASE [SAMI] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [SAMI] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [SAMI] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [SAMI] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [SAMI] SET ARITHABORT OFF 
GO
ALTER DATABASE [SAMI] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [SAMI] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [SAMI] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [SAMI] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [SAMI] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [SAMI] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [SAMI] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [SAMI] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [SAMI] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [SAMI] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [SAMI] SET  ENABLE_BROKER 
GO
ALTER DATABASE [SAMI] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [SAMI] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [SAMI] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [SAMI] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [SAMI] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [SAMI] SET  READ_WRITE 
GO
ALTER DATABASE [SAMI] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [SAMI] SET  MULTI_USER 
GO
ALTER DATABASE [SAMI] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [SAMI] SET DB_CHAINING OFF 
GO
-- The next three commented statements are used to create a user with access to the SAMI database.
...
--GO
--CREATE ROLE [SAMIManagerRole] AUTHORIZATION [dbo]
--GO
--EXEC sp_addrolemember N'SAMIManagerRole', N'NewUser'
--GO
--EXEC sp_addrolemember N'db_datareader', N'SAMIManagerRole'
--GO
--EXEC sp_addrolemember N'db_datawriter', N'SAMIManagerRole'
--GO
