...
--       Script is based on SIMProx.sql script created by James Ritchie Carroll.
...
USE [master]
GO
CREATE DATABASE [SIMProx];
GO
ALTER DATABASE [SIMProx] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [SIMProx] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [SIMProx] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [SIMProx] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [SIMProx] SET ARITHABORT OFF 
GO
ALTER DATABASE [SIMProx] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [SIMProx] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [SIMProx] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [SIMProx] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [SIMProx] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [SIMProx] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [SIMProx] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [SIMProx] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [SIMProx] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [SIMProx] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [SIMProx] SET  ENABLE_BROKER 
GO
ALTER DATABASE [SIMProx] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [SIMProx] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [SIMProx] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [SIMProx] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [SIMProx] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [SIMProx] SET  READ_WRITE 
GO
ALTER DATABASE [SIMProx] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [SIMProx] SET  MULTI_USER 
GO
ALTER DATABASE [SIMProx] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [SIMProx] SET DB_CHAINING OFF 
GO
-- The next three commented statements are used to create a user with access to the SIMProx database.
...
--GO
--CREATE ROLE [SIMProxManagerRole] AUTHORIZATION [dbo]
--GO
--EXEC sp_addrolemember N'SIMProxManagerRole', N'NewUser'
--GO
--EXEC sp_addrolemember N'db_datareader', N'SIMProxManagerRole'
--GO
--EXEC sp_addrolemember N'db_datawriter', N'SIMProxManagerRole'
--GO
